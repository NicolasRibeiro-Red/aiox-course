...
export const modules: Module[] = [
  {
    ...
    description:
      "Entenda o que e o AIOX, seu diferencial e o que voce vai aprender neste curso.",
    icon: "👋",
    lessonCount: 3,
    lessons: [
      {
      ...
      },
      {
        ...
        description:
          "Por que CLI primeiro, planejamento agenico e desenvolvimento contextualizado mudam tudo.",
        sourceDocs: [
      ...
      },
      {
        ...
        description:
          "O que voce vai aprender em cada modulo e como aproveitar ao maximo.",
    ...
    lessons: [
      {
        ...
        description: "Node.js, npm, Git e IDE — tudo que voce precisa.",
      ...
      },
      {
        ...
        moduleId: "getting-started",
        number: 2,
        title: "Instalacao: npx aiox-core init",
        description: "O wizard moderno que configura tudo pra voce.",
      ...
      },
      {
        ...
        description: "Configuracoes especificas para Windows, macOS e Linux.",
        sourceDocs: [
      ...
      },
      {
        ...
        description: "Ative seu primeiro agente e veja o AIOX em acao.",
        sourceDocs: ["docs/getting-started.md"],
        estimatedMinutes: 10,
      },
      {
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description: "As duas inovacoes que separam o AIOX de outros frameworks.",
        sourceDocs: ["docs/core-architecture.md"],
        estimatedMinutes: 12,
      },
      {
      ...
      },
      {
        ...
        moduleId: "core-architecture",
        number: 5,
        title: "Glossario e Stack Tecnica",
  ...
  },
  {
    ...
    description:
      "Os 12 agentes do AIOX: personas, comandos, colaboracao e quando usar cada um.",
    icon: "🤖",
    lessonCount: 7,
    lessons: [
      {
        ...
        description: "Como agentes sao construidos e se relacionam.",
        sourceDocs: [
      ...
      },
      {
        ...
        moduleId: "agent-system",
        number: 7,
        title: "Referencia Completa de Comandos",
  ...
  },
  {
    ...
    title: "Workflows",
    description:
      "Da ideia a producao: greenfield, brownfield, story cycle e git workflow.",
    icon: "🔄",
    lessonCount: 6,
    lessons: [
      {
        ...
        description: "O pipeline que transforma ideias em especificacoes.",
      ...
      },
      {
        ...
        description: "Criando projetos do zero com orquestracao de agentes.",
        sourceDocs: [
      ...
      },
      {
        ...
        description: "Loops de qualidade e construcao de design systems.",
        sourceDocs: [
      ...
      },
      {
        ...
        description: "Gerenciamento automatico de branches e worktrees.",
        sourceDocs: [
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description: "Protegendo seu projeto e dados sensiveis.",
      ...
      },
      {
        ...
        description: "Como agentes lembram e aprendem entre sessoes.",
        sourceDocs: [
    ...
    lessons: [
      {
        ...
        number: 1,
        title: "Claude Code (Integracao Completa)",
        description: "A melhor experiencia AIOX: hooks, memory e agents nativos.",
      ...
      },
      {
        ...
        description: "AIOX em Gemini e Codex com adaptacoes.",
        sourceDocs: [
      ...
      },
      {
        ...
        description: "Integracao com IDEs visuais.",
  ...
  },
  {
    ...
    title: "Squads",
    description:
      "Times modulares de agentes: criacao, configuracao e casos reais.",
    icon: "👥",
    lessonCount: 5,
    lessons: [
      {
        ...
        moduleId: "squads",
        number: 1,
        title: "O que sao Squads?",
        description: "Times de agentes modulares e reutilizaveis.",
      ...
      },
      {
        ...
        description: "Um squad real em producao.",
      ...
      },
      {
        ...
        description: "Versionamento e migracao entre versoes.",
  ...
  },
  {
    id: "advanced",
    number: 8,
    title: "Topicos Avancados",
    description:
      "Projeto E2E, execution profiles, LLM routing e contribuicao open source.",
    icon: "🧪",
    lessonCount: 5,
    lessons: [
      {
        ...
        description: "Construindo uma aplicacao completa do zero ao deploy.",
        sourceDocs: [
          "docs/aiox-workflows/greenfield-fullstack-workflow.md",
        ],
        estimatedMinutes: 30,
      },
      {
        ...
        description: "Controle total sobre o nivel de autonomia.",
      ...
      },
      {
        ...
        description: "Estrategias para usar multiplos modelos de IA.",
